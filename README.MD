...
- Official binaries: contain proprietary components and are NOT MIT licensed

If you build the project from source, the resulting binaries are MIT-licensed. 
The proprietary components are not available within the source code of this repository.

See NOTICE for additional information about third-party components
and binary distribution terms.