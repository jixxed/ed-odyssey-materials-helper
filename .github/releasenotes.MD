...
```
Added commander stats (WIP, currently requires relog for most stats)
- Shows credits, arx, ranks and reputations
Added Dodec to colonisation options
Fixed layout issues on small text with 125% scaling
```