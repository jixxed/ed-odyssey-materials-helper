...
```
Added Rhino update merc module blueprints (available to sponsors in early access, backers: Sept. 11)
Added free planetary hangar modules
Corrected force shell experimental effect: 17% -> 16.666%
```