...
```
Update label clarifying blur MUST be disabled for AR to function properly
Some Nomad update related fixed for processing the journal
Added data used during operations
```