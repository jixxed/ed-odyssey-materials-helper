...
class HorizonsContentArea extends DestroyableAnchorPane {
    ...
    private PowerplayTab powerplayTab;
...
//    private HgeFinderTab hgeFinderTab;
    ...
    private void initComponents() {
        ...
        this.horizonsColonisationTab = new HorizonsColonisationTab();
        this.horizonsColonisationTab.setClosable(false);
//        this.hgeFinderTab = new HgeFinderTab();
//        this.hgeFinderTab.setClosable(false);

        this.searchBar = new HorizonsSearchBar();
        this.tabs = new TabPane(this.horizonsMaterialOverview, this.horizonsCommoditiesOverview, this.horizonsWishlistTab, this.horizonsShipBuilderTab,/* this.hgeFinderTab,*/ this.horizonsEngineersTab, this.powerplayTab, this.horizonsColonisationTab);
    ...
    private void initEventHandling() {
        ...
        register(EventService.addListener(true, this, HorizonsWishlistOpenShipBuilderEvent.class, horizonsWishlistOpenShipBuilderEvent -> {
        ...
        register(EventService.addListener(true, this, ApplicationLifeCycleEvent.class, applicationLifeCycleEvent -> setBodyAnchor(isRecipeBarVisible(), this.recipeBar.getWidth())));
        register(EventService.addListener(true, this, AfterFontSizeSetEvent.class, fontSizeEvent -> setBodyAnchor(isRecipeBarVisible(), this.recipeBar.getWidth())));
