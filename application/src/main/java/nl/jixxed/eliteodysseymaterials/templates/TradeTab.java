...
public class TradeTab extends EDOTab {
    ...
    private TradePagination tradeRequestsPagination;
    ...
    private void initComponents() {
        ...
        this.disconnectButton = ButtonBuilder.builder()
                ...
                .build();
        this.tradeRequestsPagination = new TradePagination(0, 0, TradeType.REQUEST);
        this.tradeOffersPagination = new TradePagination(0, 0, TradeType.OFFER);
