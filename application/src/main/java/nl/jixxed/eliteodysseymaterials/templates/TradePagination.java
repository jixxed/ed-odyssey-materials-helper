...
class TradePagination extends VBox {
    ...
    private final SimpleListProperty<Trade> visibleTrades = new SimpleListProperty<>(FXCollections.observableList(new ArrayList<>()));
    ...
    TradePagination(final int pageCount, final int pageIndex, final TradeType tradeType) {
    ...
    private void initEventHandling() {
        ...
        EventService.addListener(this, ConnectionWebSocketEvent.class, connectionWebSocketEvent -> {
            ...
            if (!connected) {
                ...
                this.visibleTrades.forEach(Trade::onDestroy);
    ...
    private Node createTradePage(final Integer pageIndex) {
        ...
        this.visibleTradeList = BoxBuilder.builder()
                .withStyleClass("trade-list")
                .withNodes(this.visibleTrades.toArray(Trade[]::new))
                .buildVBox();
