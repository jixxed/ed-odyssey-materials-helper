...
public class OdysseyWishlistBlueprintTemplate extends HBox implements WishlistBlueprintTemplate<OdysseyBlueprintName> {
    ...
    public void addWishlistIngredients(final List<Ingredient> wishlistIngredients) {
        ...
        this.wishlistIngredients.addAll(wishlistIngredients.stream().map(WishlistIngredient.class::cast).filter(wishlistIngredient -> this.blueprint.hasIngredient(wishlistIngredient.getOdysseyMaterial())).collect(Collectors.toSet()));
        this.otherIngredients.addAll(wishlistIngredients.stream().map(WishlistIngredient.class::cast).filter(wishlistIngredient -> !this.blueprint.hasIngredient(wishlistIngredient.getOdysseyMaterial())).collect(Collectors.toSet()));
    }
