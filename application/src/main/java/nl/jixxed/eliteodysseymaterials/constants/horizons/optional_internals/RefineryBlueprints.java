...
public class RefineryBlueprints {
    public static final Map<HorizonsBlueprintModificationType, Map<HorizonsBlueprintGrade, HorizonsBlueprint>> BLUEPRINTS = Map.of(
            ...
            Map.of(
                    HorizonsBlueprintGrade.GRADE_1, new HorizonsBlueprint(HorizonsBlueprintObjectName.REFINERY, HorizonsBlueprintModificationType.SHIELDED, HorizonsBlueprintGrade.GRADE_1,
                            Map.of(
                    ...
                    HorizonsBlueprintGrade.GRADE_2, new HorizonsBlueprint(HorizonsBlueprintObjectName.REFINERY, HorizonsBlueprintModificationType.SHIELDED, HorizonsBlueprintGrade.GRADE_2,
                            Map.of(
                                    Raw.CARBON, 1,
                            ...
                            List.of(Engineer.MARSHA_HICKS, Engineer.BILL_TURNER, Engineer.LORI_JAMESON)),
                    HorizonsBlueprintGrade.GRADE_3, new HorizonsBlueprint(HorizonsBlueprintObjectName.REFINERY, HorizonsBlueprintModificationType.SHIELDED, HorizonsBlueprintGrade.GRADE_3,
                            Map.of(
                                    Raw.CARBON, 1,
                            ...
                            List.of(Engineer.MARSHA_HICKS, Engineer.BILL_TURNER, Engineer.LORI_JAMESON)),
                    HorizonsBlueprintGrade.GRADE_4, new HorizonsBlueprint(HorizonsBlueprintObjectName.REFINERY, HorizonsBlueprintModificationType.SHIELDED, HorizonsBlueprintGrade.GRADE_4,
                            Map.of(
                    ...
                    HorizonsBlueprintGrade.GRADE_5, new HorizonsBlueprint(HorizonsBlueprintObjectName.REFINERY, HorizonsBlueprintModificationType.SHIELDED, HorizonsBlueprintGrade.GRADE_5,
                            Map.of(
