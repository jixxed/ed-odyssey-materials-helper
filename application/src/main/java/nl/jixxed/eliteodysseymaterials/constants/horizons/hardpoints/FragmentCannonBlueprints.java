    ...
    public static final Map<HorizonsBlueprintType, Map<HorizonsBlueprintGrade, HorizonsBlueprint>> BLUEPRINTS = Map.of(
            ...
            Map.of(
                    HorizonsBlueprintGrade.GRADE_1, new HorizonsModuleBlueprint(HorizonsBlueprintName.FRAGMENT_CANNON, HorizonsBlueprintType.DOUBLE_SHOT, HorizonsBlueprintGrade.GRADE_1,
                            ...
                            Map.of(
                                    HorizonsModifier.CLIP_SIZE, new HorizonsNumberModifierValue("4", true, constant(4.0)),
                                    HorizonsModifier.BURST_RATE_OF_FIRE, new HorizonsNumberModifierValue("+600%", true, percentagePositive(0.0, 6.0)),
                                    HorizonsModifier.BURST_SIZE, new HorizonsNumberModifierValue("2", true, constant(2.0)),
                    ...
                    HorizonsBlueprintGrade.GRADE_5, new HorizonsModuleBlueprint(HorizonsBlueprintName.FRAGMENT_CANNON, HorizonsBlueprintType.DOUBLE_SHOT, HorizonsBlueprintGrade.GRADE_5,
                            ...
                            Map.of(
                                    HorizonsModifier.CLIP_SIZE, new HorizonsNumberModifierValue("6", true, constant(6.0)),
