            ...
            Map.of(
                    HorizonsBlueprintGrade.GRADE_5, new HorizonsModuleBlueprint(HorizonsBlueprintName.RAIL_GUN, HorizonsBlueprintType.LONG_RANGE_WEAPON_HIGH_CAPACITY_MAGAZINE_FEEDBACK_CASCADE, HorizonsBlueprintGrade.GRADE_5,
                            ...
                            Map.ofEntries(
                                   ...
                                   Map.entry(HorizonsModifier.DAMAGE_PER_SECOND, new HorizonsNumberModifierValue("+6.7%", true, percentagePositive(0.0, 0.067))),
                                   ...
                                   Map.entry(HorizonsModifier.RATE_OF_FIRE, new HorizonsNumberModifierValue("+33%", true, percentagePositive(0.0, 0.33))),
