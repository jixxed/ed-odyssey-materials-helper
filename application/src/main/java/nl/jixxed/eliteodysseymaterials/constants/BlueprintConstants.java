...
public abstract class BlueprintConstants {
    private static final ApplicationState APPLICATION_STATE = ApplicationState.getInstance();
    private static final Map<BlueprintName, UpgradeBlueprint> SUIT_UPGRADES = new EnumMap<>(BlueprintName.class);
    private static final Map<BlueprintName, UpgradeBlueprint> WEAPON_UPGRADES = new EnumMap<>(BlueprintName.class);
    private static final Map<BlueprintName, ModuleBlueprint> SUIT_MODULE_BLUEPRINTS = new EnumMap<>(BlueprintName.class);
    private static final Map<BlueprintName, ModuleBlueprint> WEAPON_MODULE_BLUEPRINTS = new EnumMap<>(BlueprintName.class);
    private static final Map<BlueprintName, EngineerBlueprint> ENGINEER_UNLOCK_REQUIREMENTS = new EnumMap<>(BlueprintName.class);
    public static final Map<BlueprintCategory, Map<BlueprintName, ? extends Blueprint>> RECIPES = Map.of(
    ...
    public static Blueprint getRecipe(final BlueprintName name) {
        Blueprint blueprint = WEAPON_MODULE_BLUEPRINTS.get(name);
        if (blueprint != null) {
            return blueprint;
        }
    ...
    public static Map<BlueprintName, Integer> findRecipesContaining(final OdysseyMaterial odysseyMaterial) {
        final Map<BlueprintName, Integer> newMap = new EnumMap<>(BlueprintName.class);
        RECIPES.values()
    ...
    public static Map<BlueprintName, ModuleBlueprint> getSuitModuleBlueprints() {
        return SUIT_MODULE_BLUEPRINTS;
    }

    public static Map<BlueprintName, ModuleBlueprint> getWeaponModuleBlueprints() {
        return WEAPON_MODULE_BLUEPRINTS;
    }

    static {
        ENGINEER_UNLOCK_REQUIREMENTS.put(BlueprintName.ENGINEER_A1, new EngineerBlueprint(
                BlueprintName.ENGINEER_A1,
                List.of("ingredient.a1.fly"),
                () -> APPLICATION_STATE.isEngineerUnlocked(Engineer.DOMINO_GREEN)
        ));
        ENGINEER_UNLOCK_REQUIREMENTS.put(BlueprintName.ENGINEER_A2, new EngineerBlueprint(
                BlueprintName.ENGINEER_A2,
                Map.of(
                        Good.PUSH, 5
                ),
                () -> APPLICATION_STATE.isEngineerKnown(Engineer.KIT_FOWLER)
        ));
        ENGINEER_UNLOCK_REQUIREMENTS.put(BlueprintName.ENGINEER_A3, new EngineerBlueprint(
                BlueprintName.ENGINEER_A3,
                Map.of(
                        Data.OPINIONPOLLS, 10
                ),
                () -> APPLICATION_STATE.isEngineerUnlocked(Engineer.KIT_FOWLER)
        ));
        ENGINEER_UNLOCK_REQUIREMENTS.put(BlueprintName.ENGINEER_A4, new EngineerBlueprint(
                BlueprintName.ENGINEER_A4,
                Map.of(
                        Good.SURVEILLANCEEQUIPMENT, 5
                ),
                () -> APPLICATION_STATE.isEngineerKnown(Engineer.YARDEN_BOND)
        ));
        ENGINEER_UNLOCK_REQUIREMENTS.put(BlueprintName.ENGINEER_A5, new EngineerBlueprint(
                BlueprintName.ENGINEER_A5,
                Map.of(
                        Data.SMEARCAMPAIGNPLANS, 8
                ),
                () -> APPLICATION_STATE.isEngineerUnlocked(Engineer.YARDEN_BOND)
        ));
        ENGINEER_UNLOCK_REQUIREMENTS.put(BlueprintName.ENGINEER_B1, new EngineerBlueprint(
                BlueprintName.ENGINEER_B1,
                List.of("ingredient.b1.conflict"),
                () -> APPLICATION_STATE.isEngineerUnlocked(Engineer.HERO_FERRARI)
        ));
        ENGINEER_UNLOCK_REQUIREMENTS.put(BlueprintName.ENGINEER_B2, new EngineerBlueprint(
                BlueprintName.ENGINEER_B2,
                Map.of(
                        Data.SETTLEMENTDEFENCEPLANS, 15
                ),
                () -> APPLICATION_STATE.isEngineerKnown(Engineer.WELLINGTON_BECK)
        ));
        ENGINEER_UNLOCK_REQUIREMENTS.put(BlueprintName.ENGINEER_B3, new EngineerBlueprint(
                BlueprintName.ENGINEER_B3,
                Map.of(
        ...
        ENGINEER_UNLOCK_REQUIREMENTS.put(BlueprintName.ENGINEER_B4, new EngineerBlueprint(
                BlueprintName.ENGINEER_B4,
                Map.of(
                        Good.INSIGHTENTERTAINMENTSUITE, 5
                ),
                () -> APPLICATION_STATE.isEngineerKnown(Engineer.UMA_LASZLO)
        ));
        ENGINEER_UNLOCK_REQUIREMENTS.put(BlueprintName.ENGINEER_B5, new EngineerBlueprint(
                BlueprintName.ENGINEER_B5,
                List.of("ingredient.b5.sirius"),
                () -> APPLICATION_STATE.isEngineerUnlocked(Engineer.UMA_LASZLO)
        ));
        ENGINEER_UNLOCK_REQUIREMENTS.put(BlueprintName.ENGINEER_C1, new EngineerBlueprint(
                BlueprintName.ENGINEER_C1,
                List.of("ingredient.c1.restore"),
                () -> APPLICATION_STATE.isEngineerUnlocked(Engineer.JUDE_NAVARRO)
        ));
        ENGINEER_UNLOCK_REQUIREMENTS.put(BlueprintName.ENGINEER_C2, new EngineerBlueprint(
                BlueprintName.ENGINEER_C2,
                Map.of(
                        Good.GENETICREPAIRMEDS, 5
                ),
                () -> APPLICATION_STATE.isEngineerKnown(Engineer.TERRA_VELASQUEZ)
        ));
        ENGINEER_UNLOCK_REQUIREMENTS.put(BlueprintName.ENGINEER_C3, new EngineerBlueprint(
                BlueprintName.ENGINEER_C3,
                List.of("ingredient.c3.theft", "ingredient.c3.heist"),
                () -> APPLICATION_STATE.isEngineerUnlocked(Engineer.TERRA_VELASQUEZ)
        ));
        ENGINEER_UNLOCK_REQUIREMENTS.put(BlueprintName.ENGINEER_C4, new EngineerBlueprint(
                BlueprintName.ENGINEER_C4,
                Map.of(
                        Data.FINANCIALPROJECTIONS, 15
                ),
                () -> APPLICATION_STATE.isEngineerKnown(Engineer.ODEN_GEIGER)
        ));
        ENGINEER_UNLOCK_REQUIREMENTS.put(BlueprintName.ENGINEER_C5, new EngineerBlueprint(
                BlueprintName.ENGINEER_C5,
                Map.of(
        ...
        ENGINEER_UNLOCK_REQUIREMENTS.put(BlueprintName.ENGINEER_D1_1, new EngineerBlueprint(
                BlueprintName.ENGINEER_D1_1,
                List.of("ingredient.d1.1.colonia.rep"),
                () -> APPLICATION_STATE.isEngineerUnlocked(Engineer.BALTANOS)
        ));
        ENGINEER_UNLOCK_REQUIREMENTS.put(BlueprintName.ENGINEER_D1_2, new EngineerBlueprint(
                BlueprintName.ENGINEER_D1_2,
                Map.of(
        ...
        ENGINEER_UNLOCK_REQUIREMENTS.put(BlueprintName.ENGINEER_D1_3, new EngineerBlueprint(
                BlueprintName.ENGINEER_D1_3,
                List.of("ingredient.d1.3.colonia.travel"),
                () -> APPLICATION_STATE.isEngineerUnlocked(Engineer.ELEANOR_BRESA)
        ));
        ENGINEER_UNLOCK_REQUIREMENTS.put(BlueprintName.ENGINEER_D2, new EngineerBlueprint(
                BlueprintName.ENGINEER_D2,
                Map.of(
        ...
        ENGINEER_UNLOCK_REQUIREMENTS.put(BlueprintName.ENGINEER_D3, new EngineerBlueprint(
                BlueprintName.ENGINEER_D3,
                Map.of(
                        Data.FACTIONASSOCIATES, 10,
                        Data.MANUFACTURINGINSTRUCTIONS, 10,
                        Data.DIGITALDESIGNS, 10
        ...
        SUIT_UPGRADES.put(BlueprintName.MAVERICK_SUIT_GRADE_1_2, new UpgradeBlueprint(
                BlueprintName.MAVERICK_SUIT_GRADE_1_2,
                Map.of(
        ...
        SUIT_UPGRADES.put(BlueprintName.MAVERICK_SUIT_GRADE_2_3, new UpgradeBlueprint(
                BlueprintName.MAVERICK_SUIT_GRADE_2_3,
                Map.of(
        ...
        SUIT_UPGRADES.put(BlueprintName.MAVERICK_SUIT_GRADE_3_4, new UpgradeBlueprint(
                BlueprintName.MAVERICK_SUIT_GRADE_3_4,
                Map.of(
        ...
        SUIT_UPGRADES.put(BlueprintName.MAVERICK_SUIT_GRADE_4_5, new UpgradeBlueprint(
                BlueprintName.MAVERICK_SUIT_GRADE_4_5,
                Map.of(
        ...
        SUIT_UPGRADES.put(BlueprintName.DOMINATOR_SUIT_GRADE_1_2, new UpgradeBlueprint(
                BlueprintName.DOMINATOR_SUIT_GRADE_1_2,
                Map.of(
                        Good.SUITSCHEMATIC, 1,
                        Good.HEALTHMONITOR, 1,
                        Good.LARGECAPACITYPOWERREGULATOR, 1,
        ...
        SUIT_UPGRADES.put(BlueprintName.DOMINATOR_SUIT_GRADE_2_3, new UpgradeBlueprint(
                BlueprintName.DOMINATOR_SUIT_GRADE_2_3,
                Map.of(
                        Good.SUITSCHEMATIC, 5,
                        Good.HEALTHMONITOR, 5,
                        Good.LARGECAPACITYPOWERREGULATOR, 5,
        ...
        SUIT_UPGRADES.put(BlueprintName.DOMINATOR_SUIT_GRADE_3_4, new UpgradeBlueprint(
                BlueprintName.DOMINATOR_SUIT_GRADE_3_4,
                Map.of(
                        Good.SUITSCHEMATIC, 10,
                        Good.HEALTHMONITOR, 10,
                        Good.LARGECAPACITYPOWERREGULATOR, 10,
        ...
        SUIT_UPGRADES.put(BlueprintName.DOMINATOR_SUIT_GRADE_4_5, new UpgradeBlueprint(
                BlueprintName.DOMINATOR_SUIT_GRADE_4_5,
                Map.of(
                        Good.SUITSCHEMATIC, 15,
                        Good.HEALTHMONITOR, 15,
                        Good.LARGECAPACITYPOWERREGULATOR, 15,
        ...
        SUIT_UPGRADES.put(BlueprintName.ARTEMIS_SUIT_GRADE_1_2, new UpgradeBlueprint(
                BlueprintName.ARTEMIS_SUIT_GRADE_1_2,
                Map.of(
                        Good.SUITSCHEMATIC, 1,
                        Good.HEALTHMONITOR, 1,
                        Good.LARGECAPACITYPOWERREGULATOR, 1,
        ...
        SUIT_UPGRADES.put(BlueprintName.ARTEMIS_SUIT_GRADE_2_3, new UpgradeBlueprint(
                BlueprintName.ARTEMIS_SUIT_GRADE_2_3,
                Map.of(
                        Good.SUITSCHEMATIC, 5,
                        Good.HEALTHMONITOR, 5,
                        Good.LARGECAPACITYPOWERREGULATOR, 5,
        ...
        SUIT_UPGRADES.put(BlueprintName.ARTEMIS_SUIT_GRADE_3_4, new UpgradeBlueprint(
                BlueprintName.ARTEMIS_SUIT_GRADE_3_4,
                Map.of(
                        Good.SUITSCHEMATIC, 10,
                        Good.HEALTHMONITOR, 10,
                        Good.LARGECAPACITYPOWERREGULATOR, 10,
        ...
        SUIT_UPGRADES.put(BlueprintName.ARTEMIS_SUIT_GRADE_4_5, new UpgradeBlueprint(
                BlueprintName.ARTEMIS_SUIT_GRADE_4_5,
                Map.of(
                        Good.SUITSCHEMATIC, 15,
                        Good.HEALTHMONITOR, 15,
                        Good.LARGECAPACITYPOWERREGULATOR, 15,
        ...
        SUIT_MODULE_BLUEPRINTS.put(BlueprintName.ADDED_MELEE_DAMAGE, new ModuleBlueprint(
                BlueprintName.ADDED_MELEE_DAMAGE,
                Map.of(
        ...
        SUIT_MODULE_BLUEPRINTS.put(BlueprintName.COMBAT_MOVEMENT_SPEED, new ModuleBlueprint(
                BlueprintName.COMBAT_MOVEMENT_SPEED,
                Map.of(
        ...
        SUIT_MODULE_BLUEPRINTS.put(BlueprintName.DAMAGE_RESISTANCE, new ModuleBlueprint(
                BlueprintName.DAMAGE_RESISTANCE,
                Map.of(
        ...
        SUIT_MODULE_BLUEPRINTS.put(BlueprintName.ENHANCED_TRACKING, new ModuleBlueprint(
                BlueprintName.ENHANCED_TRACKING,
                Map.of(
        ...
        SUIT_MODULE_BLUEPRINTS.put(BlueprintName.EXTRA_AMMO_CAPACITY, new ModuleBlueprint(
                BlueprintName.EXTRA_AMMO_CAPACITY,
                Map.of(
        ...
        SUIT_MODULE_BLUEPRINTS.put(BlueprintName.EXTRA_BACKPACK_CAPACITY, new ModuleBlueprint(
                BlueprintName.EXTRA_BACKPACK_CAPACITY,
                Map.of(
                        Data.WEAPONINVENTORY, 10,
        ...
        SUIT_MODULE_BLUEPRINTS.put(BlueprintName.FASTER_SHIELD_REGEN, new ModuleBlueprint(
                BlueprintName.FASTER_SHIELD_REGEN,
                Map.of(
        ...
        SUIT_MODULE_BLUEPRINTS.put(BlueprintName.IMPROVED_BATTERY_CAPACITY, new ModuleBlueprint(
                BlueprintName.IMPROVED_BATTERY_CAPACITY,
                Map.of(
                        Data.REACTOROUTPUTREVIEW, 10,
        ...
        SUIT_MODULE_BLUEPRINTS.put(BlueprintName.IMPROVED_JUMP_ASSIST, new ModuleBlueprint(
                BlueprintName.IMPROVED_JUMP_ASSIST,
                Map.of(
                        Good.GMEDS, 10,
                        Data.TOPOGRAPHICALSURVEYS, 10,
        ...
        SUIT_MODULE_BLUEPRINTS.put(BlueprintName.INCREASED_AIR_RESERVES, new ModuleBlueprint(
                BlueprintName.INCREASED_AIR_RESERVES,
                Map.of(
        ...
        SUIT_MODULE_BLUEPRINTS.put(BlueprintName.INCREASED_SPRINT_DURATION, new ModuleBlueprint(
                BlueprintName.INCREASED_SPRINT_DURATION,
                Map.of(
        ...
        SUIT_MODULE_BLUEPRINTS.put(BlueprintName.NIGHT_VISION, new ModuleBlueprint(
                BlueprintName.NIGHT_VISION,
                Map.of(
        ...
        SUIT_MODULE_BLUEPRINTS.put(BlueprintName.QUIETER_FOOTSTEPS, new ModuleBlueprint(
                BlueprintName.QUIETER_FOOTSTEPS,
                Map.of(
        ...
        SUIT_MODULE_BLUEPRINTS.put(BlueprintName.REDUCED_TOOL_BATTERY_CONSUMPTION, new ModuleBlueprint(
                BlueprintName.REDUCED_TOOL_BATTERY_CONSUMPTION,
                Map.of(
                        Data.REACTOROUTPUTREVIEW, 10,
                        Asset.ELECTRICALWIRING, 15,
        ...
        WEAPON_UPGRADES.put(BlueprintName.KARMA_1_2, new UpgradeBlueprint(
                BlueprintName.KARMA_1_2,
                Map.of(
        ...
        WEAPON_UPGRADES.put(BlueprintName.KARMA_2_3, new UpgradeBlueprint(
                BlueprintName.KARMA_2_3,
                Map.of(
        ...
        WEAPON_UPGRADES.put(BlueprintName.KARMA_3_4, new UpgradeBlueprint(
                BlueprintName.KARMA_3_4,
                Map.of(
        ...
        WEAPON_UPGRADES.put(BlueprintName.KARMA_4_5, new UpgradeBlueprint(
                BlueprintName.KARMA_4_5,
                Map.of(
        ...
        WEAPON_UPGRADES.put(BlueprintName.TK_1_2, new UpgradeBlueprint(
                BlueprintName.TK_1_2,
                Map.of(
                        Good.WEAPONSCHEMATIC, 1,
                        Good.IONISEDGAS, 1,
                        Data.MANUFACTURINGINSTRUCTIONS, 1,
        ...
        WEAPON_UPGRADES.put(BlueprintName.TK_2_3, new UpgradeBlueprint(
                BlueprintName.TK_2_3,
                Map.of(
                        Good.WEAPONSCHEMATIC, 5,
                        Good.IONISEDGAS, 5,
                        Data.MANUFACTURINGINSTRUCTIONS, 5,
        ...
        WEAPON_UPGRADES.put(BlueprintName.TK_3_4, new UpgradeBlueprint(
                BlueprintName.TK_3_4,
                Map.of(
                        Good.WEAPONSCHEMATIC, 10,
                        Good.IONISEDGAS, 10,
                        Data.MANUFACTURINGINSTRUCTIONS, 10,
        ...
        WEAPON_UPGRADES.put(BlueprintName.TK_4_5, new UpgradeBlueprint(
                BlueprintName.TK_4_5,
                Map.of(
                        Good.WEAPONSCHEMATIC, 15,
                        Good.IONISEDGAS, 15,
                        Data.MANUFACTURINGINSTRUCTIONS, 15,
        ...
        WEAPON_UPGRADES.put(BlueprintName.MANTICORE_1_2, new UpgradeBlueprint(
                BlueprintName.MANTICORE_1_2,
                Map.of(
                        Good.WEAPONSCHEMATIC, 1,
                        Good.IONISEDGAS, 1,
                        Data.MANUFACTURINGINSTRUCTIONS, 1,
        ...
        WEAPON_UPGRADES.put(BlueprintName.MANTICORE_2_3, new UpgradeBlueprint(
                BlueprintName.MANTICORE_2_3,
                Map.of(
                        Good.WEAPONSCHEMATIC, 5,
                        Good.IONISEDGAS, 5,
                        Data.MANUFACTURINGINSTRUCTIONS, 5,
        ...
        WEAPON_UPGRADES.put(BlueprintName.MANTICORE_3_4, new UpgradeBlueprint(
                BlueprintName.MANTICORE_3_4,
                Map.of(
                        Good.WEAPONSCHEMATIC, 10,
                        Good.IONISEDGAS, 10,
                        Data.MANUFACTURINGINSTRUCTIONS, 10,
        ...
        WEAPON_UPGRADES.put(BlueprintName.MANTICORE_4_5, new UpgradeBlueprint(
                BlueprintName.MANTICORE_4_5,
                Map.of(
                        Good.WEAPONSCHEMATIC, 15,
                        Good.IONISEDGAS, 15,
                        Data.MANUFACTURINGINSTRUCTIONS, 15,
        ...
        WEAPON_MODULE_BLUEPRINTS.put(BlueprintName.AUDIO_MASKING, new ModuleBlueprint(
                BlueprintName.AUDIO_MASKING,
                Map.of(
                        Data.AUDIOLOGS, 5,
                        Data.PATROLROUTES, 10,
                        Asset.SCRAMBLER, 10,
        ...
        WEAPON_MODULE_BLUEPRINTS.put(BlueprintName.FASTER_HANDLING, new ModuleBlueprint(
                BlueprintName.FASTER_HANDLING,
                Map.of(
        ...
        WEAPON_MODULE_BLUEPRINTS.put(BlueprintName.GREATER_RANGE_KINETIC, new ModuleBlueprint(
                BlueprintName.GREATER_RANGE_KINETIC,
                Map.of(
                        Data.BALLISTICSDATA, 10,
                        Data.TOPOGRAPHICALSURVEYS, 10,
                        Asset.METALCOIL, 10,
        ...
        WEAPON_MODULE_BLUEPRINTS.put(BlueprintName.GREATER_RANGE_LASER, new ModuleBlueprint(
                BlueprintName.GREATER_RANGE_LASER,
                Map.of(
                        Data.STELLARACTIVITYLOGS, 10,
        ...
        WEAPON_MODULE_BLUEPRINTS.put(BlueprintName.GREATER_RANGE_PLASMA, new ModuleBlueprint(
                BlueprintName.GREATER_RANGE_PLASMA,
                Map.of(
        ...
        WEAPON_MODULE_BLUEPRINTS.put(BlueprintName.HEADSHOT_DAMAGE_KINETIC, new ModuleBlueprint(
                BlueprintName.HEADSHOT_DAMAGE_KINETIC,
                Map.of(
                        Data.WEAPONTESTDATA, 10,
        ...
        WEAPON_MODULE_BLUEPRINTS.put(BlueprintName.HEADSHOT_DAMAGE_LASER, new ModuleBlueprint(
                BlueprintName.HEADSHOT_DAMAGE_LASER,
                Map.of(
                        Data.SPECTRALANALYSISDATA, 10,
        ...
        WEAPON_MODULE_BLUEPRINTS.put(BlueprintName.HEADSHOT_DAMAGE_PLASMA, new ModuleBlueprint(
                BlueprintName.HEADSHOT_DAMAGE_PLASMA,
                Map.of(
        ...
        WEAPON_MODULE_BLUEPRINTS.put(BlueprintName.HIGHER_ACCURACY_KINETIC, new ModuleBlueprint(
                BlueprintName.HIGHER_ACCURACY_KINETIC,
                Map.of(
        ...
        WEAPON_MODULE_BLUEPRINTS.put(BlueprintName.HIGHER_ACCURACY_LASER, new ModuleBlueprint(
                BlueprintName.HIGHER_ACCURACY_LASER,
                Map.of(
                        Data.RADIOACTIVITYDATA, 5,
                        Data.COMBATANTPERFORMANCE, 10,
                        Asset.OPTICALLENS, 5,
        ...
        WEAPON_MODULE_BLUEPRINTS.put(BlueprintName.HIGHER_ACCURACY_PLASMA, new ModuleBlueprint(
                BlueprintName.HIGHER_ACCURACY_PLASMA,
                Map.of(
        ...
        WEAPON_MODULE_BLUEPRINTS.put(BlueprintName.MAGAZINE_SIZE, new ModuleBlueprint(
                BlueprintName.MAGAZINE_SIZE,
                Map.of(
                        Data.WEAPONTESTDATA, 10,
        ...
        WEAPON_MODULE_BLUEPRINTS.put(BlueprintName.NOISE_SUPPRESSOR, new ModuleBlueprint(
                BlueprintName.NOISE_SUPPRESSOR,
                Map.of(
        ...
        WEAPON_MODULE_BLUEPRINTS.put(BlueprintName.RELOAD_SPEED, new ModuleBlueprint(
                BlueprintName.RELOAD_SPEED,
                Map.of(
                        Data.OPERATIONALMANUAL, 10,
                        Data.PRODUCTIONREPORTS, 10,
                        Data.COMBATTRAININGMATERIAL, 10,
        ...
        WEAPON_MODULE_BLUEPRINTS.put(BlueprintName.SCOPE, new ModuleBlueprint(
                BlueprintName.SCOPE,
                Map.of(
                        Data.SPECTRALANALYSISDATA, 10,
                        Data.BIOMETRICDATA, 5,
        ...
        WEAPON_MODULE_BLUEPRINTS.put(BlueprintName.STABILITY, new ModuleBlueprint(
                BlueprintName.STABILITY,
                Map.of(
                        Data.MININGANALYTICS, 10,
                        Data.RISKASSESSMENTS, 15,
                        Asset.VISCOELASTICPOLYMER, 10,
        ...
        WEAPON_MODULE_BLUEPRINTS.put(BlueprintName.STOWED_RELOADING, new ModuleBlueprint(
                BlueprintName.STOWED_RELOADING,
                Map.of(
                        Data.DIGITALDESIGNS, 10,
                        Data.OPERATIONALMANUAL, 10,
