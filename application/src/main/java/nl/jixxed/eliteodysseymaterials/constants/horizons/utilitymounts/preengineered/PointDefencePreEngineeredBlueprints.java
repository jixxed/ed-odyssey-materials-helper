            ...
            Map.of(
                    HorizonsBlueprintGrade.GRADE_5, new HorizonsModuleBlueprint(HorizonsBlueprintName.POINT_DEFENCE, HorizonsBlueprintType.LIGHTWEIGHT_FOCUSED, HorizonsBlueprintGrade.GRADE_5,
                            ...
                            Map.of(
                                    ...
                                    HorizonsModifier.THERMAL_LOAD, new HorizonsNumberModifierValue("+5%", false, percentageNegative(0.0, 0.05)),
                                    HorizonsModifier.MAXIMUM_RANGE, new HorizonsNumberModifierValue("+100%", true, percentageNegative(0.0, 1.0)),
                                    HorizonsModifier.SHOT_SPEED, new HorizonsNumberModifierValue("+100%", true, percentageNegative(0.0, 1.0))
                            ),
                            List.of(
                            ),
                            true
