...
public class SpawnConstants {
    ...
    static {
        HORIZONSMATERIAL_LOCATION.put(Raw.ANTIMONY, List.of(BRAIN_TREES_ANTIMONY, CRYSTAL_SHARDS_ANTIMONY, FIXED_CRYSTAL_SHARDS_ANTIMONY, CRASHED_SHIP_ANACONDA_005, SURFACE_PROSPECTING));
        ...
        HORIZONSMATERIAL_LOCATION.put(Raw.POLONIUM, List.of(BRAIN_TREES_POLONIUM, CRYSTAL_SHARDS_POLONIUM, FIXED_CRYSTAL_SHARDS_POLONIUM, SURFACE_PROSPECTING));
        HORIZONSMATERIAL_LOCATION.put(Raw.RHENIUM, List.of(SURFACE_PROSPECTING, RING_ALL, ASTEROIDS));
        HORIZONSMATERIAL_LOCATION.put(Raw.RUTHENIUM, List.of(BRAIN_TREES_RUTHENIUM, CRYSTAL_SHARDS_RUTHENIUM, FIXED_CRYSTAL_SHARDS_RUTHENIUM, CRASHED_SHIP_ANACONDA_005, SURFACE_PROSPECTING));
        HORIZONSMATERIAL_LOCATION.put(Raw.SELENIUM, List.of(BRAIN_TREES_SELENIUM, SURFACE_PROSPECTING));
        HORIZONSMATERIAL_LOCATION.put(Raw.SULPHUR, List.of(SURFACE_PROSPECTING, RING_ALL, ASTEROIDS));
        HORIZONSMATERIAL_LOCATION.put(Raw.TECHNETIUM, List.of(BRAIN_TREES_TECHNETIUM, CRYSTAL_SHARDS_TECHNETIUM, FIXED_CRYSTAL_SHARDS_TECHNETIUM, SURFACE_PROSPECTING));
        HORIZONSMATERIAL_LOCATION.put(Raw.TELLURIUM, List.of(BRAIN_TREES_TELLURIUM, CRYSTAL_SHARDS_TELLURIUM, FIXED_CRYSTAL_SHARDS_TELLURIUM, CRASHED_SHIP_ANACONDA_005, SURFACE_PROSPECTING));
        HORIZONSMATERIAL_LOCATION.put(Raw.TIN, List.of(SURFACE_PROSPECTING, RING_ALL));
        HORIZONSMATERIAL_LOCATION.put(Raw.TUNGSTEN, List.of(CRASHED_SHIP_ANACONDA_005, SURFACE_PROSPECTING));
        HORIZONSMATERIAL_LOCATION.put(Raw.VANADIUM, List.of(SURFACE_PROSPECTING, RING_ICE));
        HORIZONSMATERIAL_LOCATION.put(Raw.YTTRIUM, List.of(BRAIN_TREES_YTTRIUM, CRYSTAL_SHARDS_YTTRIUM, FIXED_CRYSTAL_SHARDS_YTTRIUM,SURFACE_PROSPECTING));
        HORIZONSMATERIAL_LOCATION.put(Raw.ZINC, List.of(SURFACE_PROSPECTING, RING_PRISTINE));
        HORIZONSMATERIAL_LOCATION.put(Raw.ZIRCONIUM, List.of(CRASHED_SHIP_ANACONDA_005, SURFACE_PROSPECTING, RING_ALL));
        ...
        HORIZONSMATERIAL_LOCATION.put(Encoded.UNKNOWNWAKEDATA, List.of(THARGOID_WAKE_SCAN));
        ...
        HORIZONSMATERIAL_LOCATION.put(Manufactured.UNKNOWNENERGYSOURCE, List.of(THARGOID_SCAVENGER, CRASHED_THARGOID_SHIP));
