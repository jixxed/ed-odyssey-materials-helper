...
public class SpawnConstants {
    ...
    static {
        HORIZONSMATERIAL_LOCATION.put(Raw.ANTIMONY, List.of(CRYSTAL_SHARDS_ANTIMONY, CRASHED_SHIP_ANACONDA_005, SURFACE_PROSPECTING));
        ...
        HORIZONSMATERIAL_LOCATION.put(Raw.RUTHENIUM, List.of(CRYSTAL_SHARDS_RUTHENIUM, CRASHED_SHIP_ANACONDA_005, SURFACE_PROSPECTING));
        ...
        HORIZONSMATERIAL_LOCATION.put(Raw.TELLURIUM, List.of(CRYSTAL_SHARDS_TELLURIUM, CRASHED_SHIP_ANACONDA_005, SURFACE_PROSPECTING));
