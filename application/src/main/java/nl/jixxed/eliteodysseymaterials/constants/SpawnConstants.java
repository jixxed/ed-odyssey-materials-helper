...
public class SpawnConstants {
    ...
    static {
        ...
        HORIZONSMATERIAL_LOCATION.put(Encoded.ADAPTIVEENCRYPTORS, List.of(JAMESON_MEMORIAL, SCAN_MISSIONS));
        ...
        HORIZONSMATERIAL_LOCATION.put(Encoded.ENCRYPTIONARCHIVES, List.of(JAMESON_MEMORIAL, SCAN_MISSIONS));
        ...
        HORIZONSMATERIAL_LOCATION.put(Encoded.ENCRYPTIONCODES, List.of(SETTLEMENT_DATAPOINT, ENCODED_EMISSIONS_DATA_BEACON));
        ...
        HORIZONSMATERIAL_LOCATION.put(Manufactured.CHEMICALPROCESSORS, List.of(DAVS_HOPE, HOT_JUPITER, ENCODED_EMISSIONS_HIGH_MED, DEGRADED_EMISSIONS, RES_HAULAGE, RES_COMBAT));
        ...
        HORIZONSMATERIAL_LOCATION.put(Manufactured.FEDCORECOMPOSITES, List.of(HGE_FEDERATION_NONE));
        ...
        HORIZONSMATERIAL_LOCATION.put(Manufactured.IMPERIALSHIELDING, List.of(HGE_EMPIRE_NONE_ELECTION));
        HORIZONSMATERIAL_LOCATION.put(Manufactured.IMPROVISEDCOMPONENTS, List.of(HGE_INDEPENDENT_ALLIANCE_CIVIL_UNREST));
        ...
        HORIZONSMATERIAL_LOCATION.put(Manufactured.MILITARYGRADEALLOYS, List.of(HGE_WAR));
        HORIZONSMATERIAL_LOCATION.put(Manufactured.MILITARYSUPERCAPACITORS, List.of(HGE_WAR));
        HORIZONSMATERIAL_LOCATION.put(Manufactured.PHARMACEUTICALISOLATORS, List.of(HGE_INDEPENDENT_ALLIANCE_OUTBREAK));
        ...
        HORIZONSMATERIAL_LOCATION.put(Manufactured.FEDPROPRIETARYCOMPOSITES, List.of(HGE_EMPIRE_FEDERATION_NONE_ELECTION));
        HORIZONSMATERIAL_LOCATION.put(Manufactured.PROTOHEATRADIATORS, List.of(MISSION_REWARD, HGE_INDEPENDENT_ALLIANCE_BOOM));
        HORIZONSMATERIAL_LOCATION.put(Manufactured.PROTOLIGHTALLOYS, List.of(HGE_INDEPENDENT_ALLIANCE_BOOM));
        HORIZONSMATERIAL_LOCATION.put(Manufactured.PROTORADIOLICALLOYS, List.of(HGE_INDEPENDENT_ALLIANCE_BOOM));
