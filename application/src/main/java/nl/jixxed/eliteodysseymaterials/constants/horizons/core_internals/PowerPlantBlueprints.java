...
public class PowerPlantBlueprints {
    public static final Map<HorizonsBlueprintType, Map<HorizonsBlueprintGrade, HorizonsBlueprint>> BLUEPRINTS = Map.of(
            ...
            Map.of(
                    HorizonsBlueprintGrade.GRADE_1, new HorizonsModuleBlueprint(HorizonsBlueprintName.POWER_PLANT, HorizonsBlueprintType.ARMOURED, HorizonsBlueprintGrade.GRADE_1,
                            ...
                            Map.of(
                                    HorizonsModifier.POWER_CAPACITY, new HorizonsNumberModifierValue("+4%", true, percentagePositive(0.02, 0.04)),
                                    HorizonsModifier.INTEGRITY, new HorizonsNumberModifierValue("+40%", true, percentagePositive(0.2, 0.40)),
                                    HorizonsModifier.HEAT_EFFICIENCY, new HorizonsNumberModifierValue("-4%", true, percentageNegative(0.02, 0.04)),
            ...
            Map.of(
                    HorizonsBlueprintGrade.GRADE_1, new HorizonsModuleBlueprint(HorizonsBlueprintName.POWER_PLANT, HorizonsBlueprintType.LOW_EMISSIONS, HorizonsBlueprintGrade.GRADE_1,
                            ...
                            Map.of(
                                    HorizonsModifier.MASS, new HorizonsNumberModifierValue("+4%", false, percentagePositive(0.0, 0.04)),
                                    HorizonsModifier.HEAT_EFFICIENCY, new HorizonsNumberModifierValue("-25%", true, percentageNegative(0.15, 0.25)),
            ...
            Map.of(
                    HorizonsBlueprintGrade.GRADE_1, new HorizonsModuleBlueprint(HorizonsBlueprintName.POWER_PLANT, HorizonsBlueprintType.OVERCHARGED, HorizonsBlueprintGrade.GRADE_1,
                            ...
                            Map.of(
                                    ...
                                    HorizonsModifier.POWER_CAPACITY, new HorizonsNumberModifierValue("+12%", true, percentagePositive(0.05, 0.12))
                            ),
                            List.of(Engineer.ETIENNE_DORN, Engineer.FELICITY_FARSEER, Engineer.MARCO_QWENT, Engineer.HERA_TANI)),
    ...
    public static final Map<HorizonsBlueprintType, Map<HorizonsBlueprintGrade, HorizonsBlueprint>> GUARDIAN_BLUEPRINTS = Map.of(
            ...
            Map.of(
                    HorizonsBlueprintGrade.GRADE_1, new HorizonsModuleBlueprint(HorizonsBlueprintName.POWER_PLANT, HorizonsBlueprintType.ANTI_GUARDIAN_ZONE_RESISTANCE, HorizonsBlueprintGrade.GRADE_1,
                            Map.of(
