...
public class EDDNScanMapper extends EDDNMapper {
    public static Message mapToEDDN(final Scan scan, final Expansion expansion) {
        return new Message.MessageBuilder()
                ...
                .withAtmosphereComposition(scan.getAtmosphereComposition()
                ...
                .withRings(scan.getRings().map(rings -> rings.stream()
                                ...
                                .toList())
                        .orElse(null))
                .withMaterials(scan.getMaterials().map(materials -> materials.stream()
