...
public class EDDNCarrierJumpMapper extends EDDNMapper {
    ...
    public static Message mapToEDDN(final CarrierJump carrierJump, final Expansion expansion) {
        return new Message.MessageBuilder()
                ...
                .withPowerplayStateReinforcement(carrierJump.getPowerplayStateReinforcement().orElse(null))
                .withPowerplayStateUndermining(carrierJump.getPowerplayStateUndermining().orElse(null))
                .withPowerplayStateControlProgress(carrierJump.getPowerplayStateControlProgress().orElse(null))
                .withPowerplayConflictProgress(mapToOptionalEmptyIfEmptyList(carrierJump.getPowerplayConflictProgress())
                        .map(powerplayConflictProgresses -> powerplayConflictProgresses.stream()
                                .map(powerplayConflictProgress -> new PowerplayConflictProgress.PowerplayConflictProgressBuilder()
                                        .withPower(powerplayConflictProgress.getPower())
                                        .withConflictProgress(powerplayConflictProgress.getConflictProgress())
                                        .build())
                                .toList())
                        .orElse(null))
                .withStationEconomies(carrierJump.getStationEconomies().map(stationEconomies -> stationEconomies.stream()
                        .map(stationEconomy -> new StationEconomy.StationEconomyBuilder()
                                ...
                                .build())
                        .toList()).orElse(null))
                .withStationEconomy(carrierJump.getStationEconomy().orElse(null))
                .withStationFaction(carrierJump.getStationFaction()
                        .map(faction -> new SystemFaction.SystemFactionBuilder()
                                ...
                                .build())
                        .orElse(null))
                .withStationGovernment(carrierJump.getStationGovernment().orElse(null))
                .withStationName(carrierJump.getStationName().orElse(null))
                .withStationServices(mapToOptionalEmptyIfEmptyList(carrierJump.getStationServices()).orElse(null))
                .withStationType(carrierJump.getStationType().orElse(null))
                ...
                .withFactions(mapToOptionalEmptyIfEmptyList(carrierJump.getFactions())
                        .map(factions -> factions.stream()
                                .map(faction -> new Faction.FactionBuilder()
                                        ...
                                        .build())
                                .toList()).orElse(null))
                .withConflicts(mapToOptionalEmptyIfEmptyList(carrierJump.getConflicts())
