...
public class EDDNLocationMapper extends EDDNMapper {
    ...
    public static Message mapToEDDN(final Location location, final Expansion expansion) {
        return new Message.MessageBuilder()
                ...
                .withPowers(location.getPowers().orElse(null))
                .withStationAllegiance(location.getSystemAllegiance())
                .withStationEconomies(location.getStationEconomies()
                ...
                .withStationServices(location.getStationServices().orElse(null))
                ...
                .withFactions(location.getFactions().map(factions -> factions.stream()
                        .map(faction -> new Faction.FactionBuilder()
                                ...
                                .build())
                        .toList()).orElse(null))
                .withConflicts(location.getConflicts()
