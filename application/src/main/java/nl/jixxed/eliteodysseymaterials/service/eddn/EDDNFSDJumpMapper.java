...
public class EDDNFSDJumpMapper extends EDDNMapper {
    public static Message mapToEDDN(final FSDJump fsdjump, final Expansion expansion) {
        return new Message.MessageBuilder()
                ...
                .withPowerplayState(fsdjump.getPowerplayState().orElse(""))
                .withPowers(fsdjump.getPowers().orElse(null))
                ...
                .withFactions(fsdjump.getFactions().map(factions -> factions.stream()
                        .map(faction -> new Faction.FactionBuilder()
                                ...
                                .build())
                        .toList()).orElse(null))
                .withConflicts(fsdjump.getConflicts()
