...
public class EDDNFSDJumpMapper extends EDDNMapper {
    ...
    public static Message mapToEDDN(final FSDJump fsdjump, final Expansion expansion) {
        return new Message.MessageBuilder()
                ...
                .withPowerplayStateReinforcement(fsdjump.getPowerplayStateReinforcement().orElse(null))
                .withPowerplayStateUndermining(fsdjump.getPowerplayStateUndermining().orElse(null))
                .withPowerplayStateControlProgress(fsdjump.getPowerplayStateControlProgress().orElse(null))
                .withPowerplayConflictProgress(mapToOptionalEmptyIfEmptyList(fsdjump.getPowerplayConflictProgress())
