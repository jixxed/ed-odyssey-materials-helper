...
public class GuardianModuleReinforcementPackage extends MilitaryOptionalModule {
    ...
    public static final GuardianModuleReinforcementPackage GUARDIAN_MODULE_REINFORCEMENT_PACKAGE_5_E = new GuardianModuleReinforcementPackage("GUARDIAN_MODULE_REINFORCEMENT_PACKAGE_5_E", HorizonsBlueprintName.GUARDIAN_MODULE_REINFORCEMENT_PACKAGE, ModuleSize.SIZE_5, ModuleClass.E, Origin.GUARDIAN, 331780, "Int_GuardianModuleReinforcement_Size5_Class1", Map.ofEntries(Map.entry(HorizonsModifier.MASS,  32.0), Map.entry(HorizonsModifier.INTEGRITY,  424.0), Map.entry(HorizonsModifier.POWER_DRAW,  0.81), Map.entry(HorizonsModifier.MODULE_DEFENCE_ABSORPTION,  0.30), Map.entry(HorizonsModifier.ANTI_GUARDIAN_ZONE_RESISTANCE,  false)));
