...
public abstract class Blueprint {
    ...
    protected Blueprint(final BlueprintName blueprintName, final Map<? extends OdysseyMaterial, Integer> materials) {
        this(blueprintName, materials, Collections.emptyMap());
    }

    protected Blueprint(final BlueprintName blueprintName, final Map<? extends OdysseyMaterial, Integer> materials, final Map<OdysseyModifier, String> modifiers) {
