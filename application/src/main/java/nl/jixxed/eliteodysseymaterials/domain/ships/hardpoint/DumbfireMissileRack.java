...
public class DumbfireMissileRack extends HardpointModule {
    ...
    public Collection<HorizonsSynthesisBlueprint> synthesisBlueprints() {
        if(this.isAdvanced()) {
            return SynthesisBlueprints.CONFIGURABLE_EXPLOSIVE_MUNITIONS.values();
        }
