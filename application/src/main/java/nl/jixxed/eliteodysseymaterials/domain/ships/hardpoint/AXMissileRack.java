...
public class AXMissileRack extends HardpointModule {
    ...
    public static final AXMissileRack AX_MISSILE_RACK_2_E_F_PRE      = new AXMissileRack("AX_MISSILE_RACK_2_E_F_PRE"     , HorizonsBlueprintName.AX_MISSILE_RACK_PRE, ModuleSize.SIZE_2, ModuleClass.E, false, Mounting.FIXED   , 0, "Hpt_ATDumbfireMissile_Fixed_Medium"      , Map.ofEntries(Map.entry(HorizonsModifier.MASS, 4.0), Map.entry(HorizonsModifier.INTEGRITY,51.0), Map.entry(HorizonsModifier.POWER_DRAW,1.20), Map.entry(HorizonsModifier.BOOT_TIME,0.0), Map.entry(HorizonsModifier.DAMAGE_PER_SECOND,15.65), Map.entry(HorizonsModifier.DAMAGE,31.3), Map.entry(HorizonsModifier.DISTRIBUTOR_DRAW,0.14), Map.entry(HorizonsModifier.THERMAL_LOAD,2.4), Map.entry(HorizonsModifier.ARMOUR_PIERCING, 60.0),                                                      Map.entry(HorizonsModifier.SHOT_SPEED, 750.0), Map.entry(HorizonsModifier.RATE_OF_FIRE,0.5), Map.entry(HorizonsModifier.BURST_INTERVAL,2.0), Map.entry(HorizonsModifier.AMMO_CLIP_SIZE, 8.0), Map.entry(HorizonsModifier.AMMO_MAXIMUM,  64.0), Map.entry(HorizonsModifier.RELOAD_TIME,5.0), Map.entry(HorizonsModifier.BREACH_DAMAGE, 0.0), Map.entry(HorizonsModifier.MIN_BREACH_CHANCE,0.80), Map.entry(HorizonsModifier.MAX_BREACH_CHANCE,1.0), Map.entry(HorizonsModifier.JITTER,  0.0), Map.entry(HorizonsModifier.ANTI_XENO_DAMAGE_RATIO, 0.6143), Map.entry(HorizonsModifier.EXPLOSIVE_DAMAGE_RATIO, 0.3857), Map.entry(HorizonsModifier.AMMO_COST,235.0)));
    public static final AXMissileRack AX_MISSILE_RACK_3_C_F_PRE      = new AXMissileRack("AX_MISSILE_RACK_3_C_F_PRE"     , HorizonsBlueprintName.AX_MISSILE_RACK_PRE, ModuleSize.SIZE_3, ModuleClass.C, false, Mounting.FIXED   , 0, "Hpt_ATDumbfireMissile_Fixed_Large"       , Map.ofEntries(Map.entry(HorizonsModifier.MASS, 8.0), Map.entry(HorizonsModifier.INTEGRITY,64.0), Map.entry(HorizonsModifier.POWER_DRAW,1.62), Map.entry(HorizonsModifier.BOOT_TIME,0.0), Map.entry(HorizonsModifier.DAMAGE_PER_SECOND,15.65), Map.entry(HorizonsModifier.DAMAGE,31.3), Map.entry(HorizonsModifier.DISTRIBUTOR_DRAW,0.24), Map.entry(HorizonsModifier.THERMAL_LOAD,3.6), Map.entry(HorizonsModifier.ARMOUR_PIERCING, 60.0),                                                      Map.entry(HorizonsModifier.SHOT_SPEED, 750.0), Map.entry(HorizonsModifier.RATE_OF_FIRE,0.5), Map.entry(HorizonsModifier.BURST_INTERVAL,2.0), Map.entry(HorizonsModifier.AMMO_CLIP_SIZE,12.0), Map.entry(HorizonsModifier.AMMO_MAXIMUM, 128.0), Map.entry(HorizonsModifier.RELOAD_TIME,5.0), Map.entry(HorizonsModifier.BREACH_DAMAGE, 0.0), Map.entry(HorizonsModifier.MIN_BREACH_CHANCE,0.80), Map.entry(HorizonsModifier.MAX_BREACH_CHANCE,1.0), Map.entry(HorizonsModifier.JITTER,  0.0), Map.entry(HorizonsModifier.ANTI_XENO_DAMAGE_RATIO, 0.6143), Map.entry(HorizonsModifier.EXPLOSIVE_DAMAGE_RATIO, 0.3857), Map.entry(HorizonsModifier.AMMO_COST,235.0)));
