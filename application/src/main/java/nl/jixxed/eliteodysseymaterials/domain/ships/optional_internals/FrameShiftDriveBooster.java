...
public class FrameShiftDriveBooster extends OptionalModule {
    ...
    public static final FrameShiftDriveBooster FRAME_SHIFT_DRIVE_BOOSTER_4_H = new FrameShiftDriveBooster("FRAME_SHIFT_DRIVE_BOOSTER_4_H", HorizonsBlueprintName.FRAME_SHIFT_DRIVE_BOOSTER, ModuleSize.SIZE_4, ModuleClass.H, Origin.GUARDIAN, 3245010, "Int_GuardianFSDBooster_Size4", Map.ofEntries(Map.entry(HorizonsModifier.MASS, 1.30), Map.entry(HorizonsModifier.INTEGRITY, 32.0), Map.entry(HorizonsModifier.POWER_DRAW, 1.65), Map.entry(HorizonsModifier.BOOT_TIME, 15.0), Map.entry(HorizonsModifier.JUMP_RANGE_INCREASE, 9.25), Map.entry(HorizonsModifier.ANTI_GUARDIAN_ZONE_RESISTANCE,  false)));
