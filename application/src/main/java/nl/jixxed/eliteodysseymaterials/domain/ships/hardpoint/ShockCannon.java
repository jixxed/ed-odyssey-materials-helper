...
public class ShockCannon extends HardpointModule {
    ...
    public static final ShockCannon SHOCK_CANNON_3_C_F_MK_II = new ShockCannon("SHOCK_CANNON_3_C_F_MK_II", HorizonsBlueprintName.SHOCK_CANNON_MK_II_PLASMA, ModuleSize.SIZE_3, ModuleClass.D,true, Mounting.FIXED, 4730944, "hpt_mkiiplasmashockautocannon_fixed_large", Map.ofEntries(Map.entry(HorizonsModifier.MASS,  8.0), Map.entry(HorizonsModifier.INTEGRITY,  64.0), Map.entry(HorizonsModifier.POWER_DRAW,  1.51), Map.entry(HorizonsModifier.BOOT_TIME,  0.0), Map.entry(HorizonsModifier.DAMAGE_PER_SECOND,  109.3), Map.entry(HorizonsModifier.DAMAGE,  13.94), Map.entry(HorizonsModifier.DISTRIBUTOR_DRAW,  0.92), Map.entry(HorizonsModifier.THERMAL_LOAD,  1.7), Map.entry(HorizonsModifier.ARMOUR_PIERCING,  60.0), Map.entry(HorizonsModifier.MAXIMUM_RANGE,  3000.0), Map.entry(HorizonsModifier.SHOT_SPEED,  1200.0), Map.entry(HorizonsModifier.RATE_OF_FIRE,  7.84), Map.entry(HorizonsModifier.BURST_INTERVAL,  0.352), Map.entry(HorizonsModifier.BURST_RATE_OF_FIRE,28.0), Map.entry(HorizonsModifier.AMMO_CLIP_SIZE,  18.0), Map.entry(HorizonsModifier.AMMO_MAXIMUM,  Double.POSITIVE_INFINITY), Map.entry(HorizonsModifier.RELOAD_TIME,  5.0), Map.entry(HorizonsModifier.ROUNDS_PER_SHOT, 1.0), Map.entry(HorizonsModifier.BURST_SIZE, 4.0), Map.entry(HorizonsModifier.BREACH_DAMAGE,  0.7), Map.entry(HorizonsModifier.MIN_BREACH_CHANCE,  0.40), Map.entry(HorizonsModifier.MAX_BREACH_CHANCE,  0.60), Map.entry(HorizonsModifier.THERMAL_DAMAGE_RATIO,  1.0), Map.entry(HorizonsModifier.DAMAGE_FALLOFF_START,  2500.0)));
