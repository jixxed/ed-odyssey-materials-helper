...
public class GuardianPlasmaCharger extends HardpointModule {
    ...
    public static final GuardianPlasmaCharger GUARDIAN_PLASMA_CHARGER_3_C_F = new GuardianPlasmaCharger("GUARDIAN_PLASMA_CHARGER_3_C_F", HorizonsBlueprintName.GUARDIAN_PLASMA_CHARGER, ModuleSize.SIZE_3, ModuleClass.C, Origin.GUARDIAN, false, Mounting.FIXED, 1423300, "Hpt_Guardian_PlasmaLauncher_Fixed_Large",           Map.ofEntries(Map.entry(HorizonsModifier.MASS, 8.0), Map.entry(HorizonsModifier.INTEGRITY, 51.0), Map.entry(HorizonsModifier.POWER_DRAW, 3.1), Map.entry(HorizonsModifier.BOOT_TIME, 0.0), Map.entry(HorizonsModifier.DAMAGE_PER_SECOND, 5.0 * 3.85), Map.entry(HorizonsModifier.DAMAGE, 3.85), Map.entry(HorizonsModifier.CHARGE_TIME, 1.8), Map.entry(HorizonsModifier.DAMAGE_MULTIPLIER, 17.0), Map.entry(HorizonsModifier.DISTRIBUTOR_DRAW, 2.42), Map.entry(HorizonsModifier.THERMAL_LOAD, 6.15), Map.entry(HorizonsModifier.ARMOUR_PIERCING, 95.0), Map.entry(HorizonsModifier.MAXIMUM_RANGE, 3000.0), Map.entry(HorizonsModifier.SHOT_SPEED, 1200.0), Map.entry(HorizonsModifier.RATE_OF_FIRE, 5.0), Map.entry(HorizonsModifier.BURST_INTERVAL, 0.2), Map.entry(HorizonsModifier.AMMO_CLIP_SIZE, 15.0), Map.entry(HorizonsModifier.AMMO_MAXIMUM, 200.0), Map.entry(HorizonsModifier.RELOAD_TIME, 3.0), Map.entry(HorizonsModifier.BREACH_DAMAGE, 0.45), Map.entry(HorizonsModifier.MIN_BREACH_CHANCE, 0.50), Map.entry(HorizonsModifier.MAX_BREACH_CHANCE, 0.80), Map.entry(HorizonsModifier.ABSOLUTE_DAMAGE_RATIO, 0.5), Map.entry(HorizonsModifier.ANTI_XENO_DAMAGE_RATIO, 0.5), Map.entry(HorizonsModifier.DAMAGE_FALLOFF_START, 1000.0), Map.entry(HorizonsModifier.AMMO_COST, 100.0), Map.entry(HorizonsModifier.ANTI_GUARDIAN_ZONE_RESISTANCE, false)));
    ...
    public Collection<HorizonsSynthesisBlueprint> synthesisBlueprints() {
        return SynthesisBlueprints.GUARDIAN_PLASMA_CHARGER_MUNITIONS.values();
    }
}
