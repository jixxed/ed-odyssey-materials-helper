...
public class GuardianPlasmaCharger extends HardpointModule {
    ...
    public static final GuardianPlasmaCharger GUARDIAN_PLASMA_CHARGER_2_B_F = new GuardianPlasmaCharger("GUARDIAN_PLASMA_CHARGER_2_B_F", HorizonsBlueprintName.GUARDIAN_PLASMA_CHARGER, ModuleSize.SIZE_2, ModuleClass.B, Origin.GUARDIAN, false, Mounting.FIXED, 567760, "Hpt_Guardian_PlasmaLauncher_Fixed_Medium", Map.ofEntries(Map.entry(HorizonsModifier.MASS,  4.0), Map.entry(HorizonsModifier.INTEGRITY,  42.0), Map.entry(HorizonsModifier.POWER_DRAW,  2.13), Map.entry(HorizonsModifier.BOOT_TIME,  0.0), /*Map.entry(HorizonsModifier.DAMAGE_PER_SECOND,  25.0),*/ Map.entry(HorizonsModifier.DAMAGE,  2.7), Map.entry(HorizonsModifier.CHARGE_TIME,  1.8), Map.entry(HorizonsModifier.DAMAGE_MULTIPLIER,  17.0), Map.entry(HorizonsModifier.DISTRIBUTOR_DRAW,  1.25), Map.entry(HorizonsModifier.THERMAL_LOAD,  5.21), Map.entry(HorizonsModifier.ARMOUR_PIERCING,  80.0), Map.entry(HorizonsModifier.MAXIMUM_RANGE,  3000.0), Map.entry(HorizonsModifier.SHOT_SPEED,  1200.0), Map.entry(HorizonsModifier.RATE_OF_FIRE,  5.0), Map.entry(HorizonsModifier.BURST_INTERVAL,  0.2), Map.entry(HorizonsModifier.AMMO_CLIP_SIZE,  15.0), Map.entry(HorizonsModifier.AMMO_MAXIMUM,  200.0), Map.entry(HorizonsModifier.RELOAD_TIME,  3.0), Map.entry(HorizonsModifier.BREACH_DAMAGE,  1.25), Map.entry(HorizonsModifier.MIN_BREACH_CHANCE,  0.50), Map.entry(HorizonsModifier.MAX_BREACH_CHANCE,  0.80), Map.entry(HorizonsModifier.ABSOLUTE_DAMAGE_RATIO, 0.5), Map.entry(HorizonsModifier.ANTI_XENO_DAMAGE_RATIO, 0.5), Map.entry(HorizonsModifier.DAMAGE_FALLOFF_START,  1000.0), Map.entry(HorizonsModifier.AMMO_COST,  100.0), Map.entry(HorizonsModifier.ANTI_GUARDIAN_ZONE_RESISTANCE,  false)));
    ...
    public static final GuardianPlasmaCharger GUARDIAN_PLASMA_CHARGER_2_B_F_PRE = new GuardianPlasmaCharger("GUARDIAN_PLASMA_CHARGER_2_B_F_PRE", HorizonsBlueprintName.GUARDIAN_PLASMA_CHARGER_PRE, ModuleSize.SIZE_2, ModuleClass.B, Origin.GUARDIAN, false, Mounting.FIXED, 0, "Hpt_Guardian_PlasmaLauncher_Fixed_Medium", Map.ofEntries(Map.entry(HorizonsModifier.MASS,  4.0), Map.entry(HorizonsModifier.INTEGRITY,  42.0), Map.entry(HorizonsModifier.POWER_DRAW,  2.13), Map.entry(HorizonsModifier.BOOT_TIME,  0.0), /*Map.entry(HorizonsModifier.DAMAGE_PER_SECOND,  25.0),*/ Map.entry(HorizonsModifier.DAMAGE,  2.7), Map.entry(HorizonsModifier.CHARGE_TIME,  1.8), Map.entry(HorizonsModifier.DAMAGE_MULTIPLIER,  17.0), Map.entry(HorizonsModifier.DISTRIBUTOR_DRAW,  1.25), Map.entry(HorizonsModifier.THERMAL_LOAD,  5.21), Map.entry(HorizonsModifier.ARMOUR_PIERCING,  80.0), Map.entry(HorizonsModifier.MAXIMUM_RANGE,  3000.0), Map.entry(HorizonsModifier.SHOT_SPEED,  1200.0), Map.entry(HorizonsModifier.RATE_OF_FIRE,  5.0), Map.entry(HorizonsModifier.BURST_INTERVAL,  0.2), Map.entry(HorizonsModifier.AMMO_CLIP_SIZE,  15.0), Map.entry(HorizonsModifier.AMMO_MAXIMUM,  200.0), Map.entry(HorizonsModifier.RELOAD_TIME,  3.0), Map.entry(HorizonsModifier.BREACH_DAMAGE,  1.25), Map.entry(HorizonsModifier.MIN_BREACH_CHANCE,  0.50), Map.entry(HorizonsModifier.MAX_BREACH_CHANCE,  0.80), Map.entry(HorizonsModifier.ABSOLUTE_DAMAGE_RATIO, 0.5), Map.entry(HorizonsModifier.ANTI_XENO_DAMAGE_RATIO, 0.5), Map.entry(HorizonsModifier.DAMAGE_FALLOFF_START,  1000.0), Map.entry(HorizonsModifier.AMMO_COST,  100.0), Map.entry(HorizonsModifier.ANTI_GUARDIAN_ZONE_RESISTANCE,  false)));
    static {
