...
public class SinkLauncher extends UtilityModule {
    ...
    public static final SinkLauncher HEAT_SINK_LAUNCHER_0_I_PRE = new SinkLauncher("HEAT_SINK_LAUNCHER_0_I_PRE", HorizonsBlueprintName.HEAT_SINK_LAUNCHER_PRE, ModuleSize.SIZE_0, ModuleClass.I, false, Mounting.NA, 0, "Hpt_HeatSinkLauncher_Turret_Tiny", Map.ofEntries(Map.entry(HorizonsModifier.MASS,  1.3), Map.entry(HorizonsModifier.INTEGRITY,  45.0), Map.entry(HorizonsModifier.POWER_DRAW,  0.2), Map.entry(HorizonsModifier.BOOT_TIME,  0.0), Map.entry(HorizonsModifier.DISTRIBUTOR_DRAW,  2.0), Map.entry(HorizonsModifier.RATE_OF_FIRE,  0.2), Map.entry(HorizonsModifier.BURST_INTERVAL,  5.0), Map.entry(HorizonsModifier.AMMO_CLIP_SIZE,  1.0), Map.entry(HorizonsModifier.AMMO_MAXIMUM,  2.0), Map.entry(HorizonsModifier.RELOAD_TIME,  10.0), Map.entry(HorizonsModifier.HEATSINK_DURATION,  10.0), Map.entry(HorizonsModifier.THERMAL_DRAIN,  100.0), Map.entry(HorizonsModifier.AMMO_COST,  25.0)));
