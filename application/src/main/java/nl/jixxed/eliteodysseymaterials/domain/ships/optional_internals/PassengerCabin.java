...
public class PassengerCabin extends OptionalModule {
    ...
    public static final PassengerCabin ECONOMY_CLASS_PASSENGER_CABIN_4_E = new PassengerCabin("ECONOMY_CLASS_PASSENGER_CABIN_4_E", HorizonsBlueprintName.ECONOMY_CLASS_PASSENGER_CABIN, ModuleSize.SIZE_4, ModuleClass.E, false, 18960, "Int_PassengerCabin_Size4_Class1", Map.ofEntries(Map.entry(HorizonsModifier.MASS, 10.00), Map.entry(HorizonsModifier.CABIN_CAPACITY, 8), Map.entry(HorizonsModifier.CABIN_CLASS, 'E')));
    public static final PassengerCabin BUSINESS_CLASS_PASSENGER_CABIN_4_D = new PassengerCabin("BUSINESS_CLASS_PASSENGER_CABIN_4_D", HorizonsBlueprintName.BUSINESS_CLASS_PASSENGER_CABIN, ModuleSize.SIZE_4, ModuleClass.D, false, 56870, "Int_PassengerCabin_Size4_Class2", Map.ofEntries(Map.entry(HorizonsModifier.MASS, 10.00), Map.entry(HorizonsModifier.CABIN_CAPACITY, 6), Map.entry(HorizonsModifier.CABIN_CLASS, 'B')));
    public static final PassengerCabin FIRST_CLASS_PASSENGER_CABIN_4_C = new PassengerCabin("FIRST_CLASS_PASSENGER_CABIN_4_C", HorizonsBlueprintName.FIRST_CLASS_PASSENGER_CABIN, ModuleSize.SIZE_4, ModuleClass.C, false, 170600, "Int_PassengerCabin_Size4_Class3", Map.ofEntries(Map.entry(HorizonsModifier.MASS, 10.00), Map.entry(HorizonsModifier.CABIN_CAPACITY, 3), Map.entry(HorizonsModifier.CABIN_CLASS, 'F')));
    public static final PassengerCabin ECONOMY_CLASS_PASSENGER_CABIN_5_E = new PassengerCabin("ECONOMY_CLASS_PASSENGER_CABIN_5_E", HorizonsBlueprintName.ECONOMY_CLASS_PASSENGER_CABIN, ModuleSize.SIZE_5, ModuleClass.E, false, 34960, "Int_PassengerCabin_Size5_Class1", Map.ofEntries(Map.entry(HorizonsModifier.MASS, 20.00), Map.entry(HorizonsModifier.CABIN_CAPACITY, 16), Map.entry(HorizonsModifier.CABIN_CLASS, 'E')));
    public static final PassengerCabin BUSINESS_CLASS_PASSENGER_CABIN_5_D = new PassengerCabin("BUSINESS_CLASS_PASSENGER_CABIN_5_D", HorizonsBlueprintName.BUSINESS_CLASS_PASSENGER_CABIN, ModuleSize.SIZE_5, ModuleClass.D, false, 92370, "Int_PassengerCabin_Size5_Class2", Map.ofEntries(Map.entry(HorizonsModifier.MASS, 20.00), Map.entry(HorizonsModifier.CABIN_CAPACITY, 10), Map.entry(HorizonsModifier.CABIN_CLASS, 'B')));
    ...
    public static final PassengerCabin BUSINESS_CLASS_PASSENGER_CABIN_6_D = new PassengerCabin("BUSINESS_CLASS_PASSENGER_CABIN_6_D", HorizonsBlueprintName.BUSINESS_CLASS_PASSENGER_CABIN, ModuleSize.SIZE_6, ModuleClass.D, false, 184240, "Int_PassengerCabin_Size6_Class2", Map.ofEntries(Map.entry(HorizonsModifier.MASS, 40.00), Map.entry(HorizonsModifier.CABIN_CAPACITY, 16), Map.entry(HorizonsModifier.CABIN_CLASS, 'B')));
    public static final PassengerCabin FIRST_CLASS_PASSENGER_CABIN_6_C = new PassengerCabin("FIRST_CLASS_PASSENGER_CABIN_6_C", HorizonsBlueprintName.FIRST_CLASS_PASSENGER_CABIN, ModuleSize.SIZE_6, ModuleClass.C, false, 552700, "Int_PassengerCabin_Size6_Class3", Map.ofEntries(Map.entry(HorizonsModifier.MASS, 40.00), Map.entry(HorizonsModifier.CABIN_CAPACITY, 12), Map.entry(HorizonsModifier.CABIN_CLASS, 'F')));
    public static final PassengerCabin LUXURY_CLASS_PASSENGER_CABIN_6_B = new PassengerCabin("LUXURY_CLASS_PASSENGER_CABIN_6_B", HorizonsBlueprintName.LUXURY_CLASS_PASSENGER_CABIN, ModuleSize.SIZE_6, ModuleClass.B, false, 4974300, "Int_PassengerCabin_Size6_Class4", Map.ofEntries(Map.entry(HorizonsModifier.MASS, 40.00), Map.entry(HorizonsModifier.CABIN_CAPACITY, 8), Map.entry(HorizonsModifier.CABIN_CLASS, 'L')));
