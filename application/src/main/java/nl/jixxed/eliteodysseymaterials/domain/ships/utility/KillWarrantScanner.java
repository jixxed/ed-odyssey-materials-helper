...
public class KillWarrantScanner extends UtilityModule {
    ...
    public static final KillWarrantScanner KILL_WARRANT_SCANNER_0_C_PRE = new KillWarrantScanner("KILL_WARRANT_SCANNER_0_C_PRE", HorizonsBlueprintName.KILL_WARRANT_SCANNER_PRE, ModuleSize.SIZE_0, ModuleClass.C, false, Mounting.NA, 0, "Hpt_CrimeScanner_Size0_Class3", Map.ofEntries(Map.entry(HorizonsModifier.MASS, 1.3), Map.entry(HorizonsModifier.INTEGRITY, 40.0), Map.entry(HorizonsModifier.POWER_DRAW, 0.8), Map.entry(HorizonsModifier.BOOT_TIME, 2.0), Map.entry(HorizonsModifier.SCANNER_RANGE, 3000.0), Map.entry(HorizonsModifier.MAX_ANGLE, 15.0), Map.entry(HorizonsModifier.SCAN_TIME, 10.0)));
    ...
    static {
        ...
        KILL_WARRANT_SCANNER_0_C_PRE.getModifications().add(
                new Modification(HorizonsBlueprintType.FAST_SCANNER_LONG_RANGE_SCANNER, 1.0, HorizonsBlueprintGrade.GRADE_5)
        );
    }
    ...
    public boolean isPreEngineered() {
        return KILL_WARRANT_SCANNER_0_A_PRE.equals(this) || KILL_WARRANT_SCANNER_0_C_PRE.equals(this);
    }
