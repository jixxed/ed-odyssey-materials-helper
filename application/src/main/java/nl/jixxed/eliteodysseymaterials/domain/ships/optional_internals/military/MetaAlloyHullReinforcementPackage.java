...
public class MetaAlloyHullReinforcementPackage extends MilitaryOptionalModule {
    ...
    public static final List<HorizonsModifier> HIDDEN_STATS = List.of(HorizonsModifier.KINETIC_RESISTANCE, HorizonsModifier.THERMAL_RESISTANCE, HorizonsModifier.EXPLOSIVE_RESISTANCE);
