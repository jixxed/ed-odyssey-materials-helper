...
public enum Power {
    ZEMINA_TORVAL(
            ...
            Map.ofEntries(
                    ...
                    Map.entry(DumbfireMissileRack.ROCKET_PROPELLED_FSD_DISRUPTER_2_B_F, 57),
                    Map.entry(SeekerMissileRack.PACK_HOUND_MISSILE_RACK_2_B_F, 63),
    ...
    FELICIA_WINTERS(
            ...
            Map.ofEntries(
                    ...
                    Map.entry(SeekerMissileRack.PACK_HOUND_MISSILE_RACK_2_B_F, 63),
                    Map.entry(DumbfireMissileRack.ROCKET_PROPELLED_FSD_DISRUPTER_2_B_F, 70),
    ...
    LI_YONG_RUI(
            ...
            Map.ofEntries(
                    Map.entry(SeekerMissileRack.PACK_HOUND_MISSILE_RACK_2_B_F, 34),
    ...
    ARCHON_DELAINE(
            ...
            Map.ofEntries(
                    ...
                    Map.entry(DumbfireMissileRack.ROCKET_PROPELLED_FSD_DISRUPTER_2_B_F, 39),
    ...
    NAKATO_KAINE(
            ...
            Map.ofEntries(
                    ...
                    Map.entry(SeekerMissileRack.PACK_HOUND_MISSILE_RACK_2_B_F, 44),
                    Map.entry(PulseLaser.PULSE_DISRUPTOR_LASER_2_E_F, 50),
                    Map.entry(MultiCannon.ENFORCER_CANNON_1_F_F, 57),
                    Map.entry(DumbfireMissileRack.ROCKET_PROPELLED_FSD_DISRUPTER_2_B_F, 63),
    ...
    JEROME_ARCHER(
            ...
            Map.ofEntries(
                    ...
                    Map.entry(DumbfireMissileRack.ROCKET_PROPELLED_FSD_DISRUPTER_2_B_F, 44),
                    Map.entry(MultiCannon.ENFORCER_CANNON_1_F_F, 50),
                    Map.entry(SeekerMissileRack.PACK_HOUND_MISSILE_RACK_2_B_F, 57),
    ...
    PRANAV_ANTAL(
            ...
            Map.ofEntries(
                    ...
                    Map.entry(SeekerMissileRack.PACK_HOUND_MISSILE_RACK_2_B_F, 39),
                    Map.entry(DumbfireMissileRack.ROCKET_PROPELLED_FSD_DISRUPTER_2_B_F, 44),
                    Map.entry(PulseLaser.PULSE_DISRUPTOR_LASER_2_E_F, 50),
    ...
    YURI_GROM(
            ...
            Map.ofEntries(
                    Map.entry(DumbfireMissileRack.ROCKET_PROPELLED_FSD_DISRUPTER_2_B_F, 34),
                    Map.entry(SeekerMissileRack.PACK_HOUND_MISSILE_RACK_2_B_F, 39),
    ...
    A_LAVIGNY_DUVAL(
            ...
            Map.ofEntries(
                    ...
                    Map.entry(DumbfireMissileRack.ROCKET_PROPELLED_FSD_DISRUPTER_2_B_F, 83),
                    Map.entry(BurstLaser.CYTOSCRAMBLER_BURST_LASER_1_F_F, 88),
                    Map.entry(PulseLaser.PULSE_DISRUPTOR_LASER_2_E_F, 91),
    ...
    AISLING_DUVAL(
            ...
            Map.ofEntries(
                    ...
                    Map.entry(Cannon.CONCORD_CANNON_2_D_G, 63),
                    Map.entry(SeekerMissileRack.PACK_HOUND_MISSILE_RACK_2_B_F, 70),
                    Map.entry(DumbfireMissileRack.ROCKET_PROPELLED_FSD_DISRUPTER_2_B_F, 76),
