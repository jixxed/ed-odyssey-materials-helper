...
public enum HorizonsBlueprintName implements BlueprintName<HorizonsBlueprintName> {
    ...
    LANCE_BEAM_MINING_LASER(BlueprintGroup.MINING_LASERS, BlueprintCategory.HARDPOINT),
    ...
    RETRIBUTOR_BEAM_LASER(BlueprintGroup.BEAM_LASERS, BlueprintCategory.HARDPOINT),
    BURST_LASER(BlueprintGroup.BURST_LASERS, BlueprintCategory.HARDPOINT),
    CYTOSCRAMBLER_BURST_LASER(BlueprintGroup.BURST_LASERS, BlueprintCategory.HARDPOINT),
    ...
    PACIFIER_FRAGMENT_CANNON(BlueprintGroup.FRAGMENT_CANNONS, BlueprintCategory.HARDPOINT),
    ...
    ENHANCED_AX_MISSILE_RACK(BlueprintGroup.AX_MISSILE_RACKS, BlueprintCategory.HARDPOINT),
    ...
    FESTIVE_LAUNCHER(BlueprintGroup.REMOTE_RELEASE_FLAK_LAUNCHERS, BlueprintCategory.HARDPOINT),
    ...
    ADVANCED_MULTI_CANNON(BlueprintGroup.MULTI_CANNONS, BlueprintCategory.HARDPOINT),
    ENFORCER_MULTI_CANNON(BlueprintGroup.MULTI_CANNONS, BlueprintCategory.HARDPOINT),
    PLASMA_ACCELERATOR(BlueprintGroup.PLASMA_ACCELERATORS, BlueprintCategory.HARDPOINT),
    ADVANCED_PLASMA_ACCELERATOR(BlueprintGroup.PLASMA_ACCELERATORS, BlueprintCategory.HARDPOINT),
    ...
    IMPERIAL_HAMMER_RAIL_GUN(BlueprintGroup.RAIL_GUNS, BlueprintCategory.HARDPOINT),
