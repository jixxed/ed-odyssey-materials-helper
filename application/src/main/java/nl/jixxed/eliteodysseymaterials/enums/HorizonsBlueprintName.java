...
public enum HorizonsBlueprintName implements BlueprintName<HorizonsBlueprintName> {
    ...
    LIGHTWEIGHT_ALLOY_ARMOUR_DEFAULT(BlueprintGroup.ARMOURS, BlueprintCategory.CORE_INTERNAL, false),
    REINFORCED_ALLOY_ARMOUR_DEFAULT(BlueprintGroup.ARMOURS, BlueprintCategory.CORE_INTERNAL, false),
    MILITARY_GRADE_COMPOSITE_ARMOUR_DEFAULT(BlueprintGroup.ARMOURS, BlueprintCategory.CORE_INTERNAL, false),
    MIRRORED_SURFACE_COMPOSITE_ARMOUR_DEFAULT(BlueprintGroup.ARMOURS, BlueprintCategory.CORE_INTERNAL, false),
    REACTIVE_SURFACE_COMPOSITE_ARMOUR_DEFAULT(BlueprintGroup.ARMOURS, BlueprintCategory.CORE_INTERNAL, false),
