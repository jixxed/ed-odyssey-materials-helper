...
public enum HorizonsModifier {
    ...
    KINETIC_RESISTANCE(74, "KineticResistance"),
    THERMAL_RESISTANCE(75, "ThermicResistance"),
    EXPLOSIVE_RESISTANCE(76, "ExplosiveResistance"),
    CAUSTIC_RESISTANCE(77, "CausticResistance"),
