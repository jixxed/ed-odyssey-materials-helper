...
public enum BlueprintName {
    ...
    public static BlueprintName forName(final String name) {
        try {
            return BlueprintName.valueOf(name.toUpperCase());
    ...
    public static BlueprintName forEngineer(final Engineer engineer) {
