...
public enum Weapon implements Equipment {
    ...
    KINEMATIC_AR50(
            ...
            Map.entry(DynamicStat.DAMAGE, new LevelValue(1.0, 1.2, 1.6, 2.2, 2.8)),
            Map.entry(StaticStat.RATE_OF_FIRE, 9.5),
    ...
    KINEMATIC_C44(
            ...
            Map.entry(DynamicStat.MAGAZINE_SIZE, 45),
    ...
    MANTICORE_OPPRESSOR(
            ...
            Map.entry(StaticStat.DAMAGE_TYPE, "loadout.stat.value.damage_type.plasma"),
            Map.entry(StaticStat.FIRE_MODE, "loadout.stat.value.fire_mode.automatic"),
            Map.entry(DynamicStat.DAMAGE, new LevelValue( 1.1, 1.4, 1.9, 2.5, 3.275)),
