...
public enum Commodity implements HorizonsMaterial {
    ...
    HAEMATITE(CommodityType.MINERALS, FALSE),
    ...
    STEEL(CommodityType.METALS, FALSE),
    ...
    THARGOIDTISSUESAMPLETYPE6(CommodityType.SALVAGE, FALSE, GameVersion.LIVE),
    THARGOIDTISSUESAMPLETYPE7(CommodityType.SALVAGE, FALSE, GameVersion.LIVE),
    THARGOIDTISSUESAMPLETYPE9A(CommodityType.SALVAGE, FALSE, GameVersion.LIVE),
    THARGOIDTISSUESAMPLETYPE9B(CommodityType.SALVAGE, FALSE, GameVersion.LIVE),
    THARGOIDTISSUESAMPLETYPE9C(CommodityType.SALVAGE, FALSE, GameVersion.LIVE),
    THARGOIDTISSUESAMPLETYPE10A(CommodityType.SALVAGE, FALSE, GameVersion.LIVE),
    THARGOIDTISSUESAMPLETYPE10B(CommodityType.SALVAGE, FALSE, GameVersion.LIVE),
    THARGOIDTISSUESAMPLETYPE10C(CommodityType.SALVAGE, FALSE, GameVersion.LIVE),
    THARGOIDBONEFRAGMENTS(CommodityType.SALVAGE, FALSE, GameVersion.LIVE),
    THARGOIDCYSTSPECIMEN(CommodityType.SALVAGE, FALSE, GameVersion.LIVE),
    THARGOIDORGANSAMPLE(CommodityType.SALVAGE, FALSE, GameVersion.LIVE),
    THARGOIDTITANDRIVECOMPONENT(CommodityType.SALVAGE, FALSE, GameVersion.LIVE),
    UNKNOWNSACK(CommodityType.SALVAGE, FALSE, GameVersion.LIVE),
    THARGOIDPOD(CommodityType.SALVAGE, FALSE, GameVersion.LIVE),
    CORALSAP(CommodityType.SALVAGE, FALSE, GameVersion.LIVE),
    ...
    UNKNOWNMINERAL(CommodityType.SALVAGE, FALSE, GameVersion.LIVE),
    UNKNOWNREFINEDMINERAL(CommodityType.SALVAGE, FALSE, GameVersion.LIVE),
