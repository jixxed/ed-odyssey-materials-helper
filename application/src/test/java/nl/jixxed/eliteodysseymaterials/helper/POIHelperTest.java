...
class POIHelperTest {
    private final Map<String, String> testMappings = Map.ofEntries(
            ...
            Map.entry("$POIScenario_Watson_Abandoned_Buggy_01_Salvage_Medium; $USS_ThreatLevel:#threatLevel=2;", "Distress Beacon [Threat 2] (Mission)"),
            Map.entry("$POIScenario_Watson_Abandoned_Buggy_01_Easy;", "Distress Beacon [Threat 1]"),
            Map.entry("$POIScenario_Watson_Damaged_Eagle_01_Easy;", "Distress Beacon [Threat 1]"),
            Map.entry("$POIScenario_Watson_Damaged_Eagle_01_Assassination_Easy; $USS_ThreatLevel:#threatLevel=1;", "Encrypted Signal [Threat 1] (Mission)"),
            Map.entry("$POIScenario_Watson_Damaged_Sidewinder_01_Easy;", "Distress Beacon [Threat 1]"),
            ...
            Map.entry("$POIScenario_Watson_Wrecks_Anaconda_01_Easy;", "Crash Site [Threat 1]"),
            Map.entry("$POIScenario_Watson_Wrecks_Eagle_01_Salvage_Easy; $USS_ThreatLevel:#threatLevel=1;", "Crash Site [Threat 1] (Mission)"),
            Map.entry("$POIScenario_Watson_Wrecks_Fighter_01_Salvage_Easy; $USS_ThreatLevel:#threatLevel=1;", "Crash Site [Threat 1] (Mission)"),
            Map.entry("$POIScenario_Watson_Wrecks_Sidewinder_01_Salvage_Easy; $USS_ThreatLevel:#threatLevel=1;", "Crash Site [Threat 1] (Mission)"),
            Map.entry("$POIScene_Escape_Pod_02;", "Escape Pod (Type 2)"),
            Map.entry("$POIScene_Wreckage_Buggy_02;", "Minor Wreckage (Buggy Type 2)"),
            Map.entry("$POIScene_Wrecks_Eagle_01;", "Crash Site"),
            Map.entry("$POIScene_Wrecks_FedFighter_01_Skimmers;", "Crash Site"),
            Map.entry("$POIScene_Wrecks_Sidewinder_01;", "Crash Site"),
